...
namespace Alit.Marker.Model.Settings.ApplicationSettings
{
    public class ApplicationSettingsViewModel
    {
        ...
        [DisplayName("GUI theme SVG Pellate name")]
        public string GUIThemeSvgPellateName { get; set; }
        #endregion -- Level 0 
        ...
        public eMemoType SaleInvoiceDefaultMemoType { get; set; }
        ...
        public bool SaleInvoiceAllowEditGAmt { get; set; }

        public eSaleinvoiceGAmtEditReverseEffectOn SaleInvoiceGAmtEditReverseEffectOn { get; set; }
        ...
        #region Receipt No.
        [DisplayName("Apply Receipt No.")]
        public bool ReceiptNo { get; set; }

        [DisplayName("Allow to Auto Generate Receipt Number.")]
        public bool ReceiptNoAutoGenerate { get; set; }

        [DisplayName("Apply Prefix Before Receipt Number.")]
        public bool ReceiptNoPrefix { get; set; }

        [DisplayName("Default Receipt Prefix ID")]
        public long? DefaultReceiptNoPrefixID { get; set; }

        [DisplayName("Series to auto generate Receipt number")]
        public string ReceiptNoSeries { get; set; }

        [DisplayName("Allow manual editing in Receipt number.")]
        public bool ReceiptNoAllowEdit { get; set; }
        #endregion -- End Receipt No
    ...
    public enum eSaleinvoiceGAmtEditReverseEffectOn
    {
        Qty = 0,
        Rate = 1
    }
