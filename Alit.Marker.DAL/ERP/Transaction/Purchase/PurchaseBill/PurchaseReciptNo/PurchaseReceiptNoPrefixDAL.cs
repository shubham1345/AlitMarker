...
namespace Alit.Marker.DAL.ERP.Transaction.Purchase.PurchaseBill.PurchaseReciptNo
{
    public class PurchaseReceiptNoPrefixDAL : IGridCRUDDAL, ICRUDDAL, ILookupListDAL
    {
        public SavingResult SaveRecord(IGridCRUDViewModel ViewModel)
        {
            return SaveRecord((PurchaseReceiptNoPrefixViewModel)ViewModel);
        }
        ...
        public SavingResult SaveRecord(PurchaseReceiptNoPrefixViewModel ViewModel)
        {
            ...
            {
                if (IsDuplicateRecord(ViewModel.PrefixName, ViewModel.PurchaseReceiptNoPrefixID, db))
                {
                ...
                tblPurchaseReceiptNoPrefix SaveModel = null;
                if (ViewModel.PurchaseReceiptNoPrefixID == 0) // New Entry
                {
                    SaveModel = new tblPurchaseReceiptNoPrefix();
                    SaveModel.rcuid = Model.CommonProperties.LoginInfo.LoggedinUser.UserID;
                    SaveModel.rcdt = DateTime.Now;
                    SaveModel.CompanyID = Model.CommonProperties.LoginInfo.LoggedInCompany.CompanyID;
                    db.tblPurchaseReceiptNoPrefixes.Add(SaveModel);
                }
                else
                {
                    SaveModel = db.tblPurchaseReceiptNoPrefixes.Find(ViewModel.PurchaseReceiptNoPrefixID);
                    ...
                    db.tblPurchaseReceiptNoPrefixes.Attach(SaveModel);
                ...
                try
                {
                    ...
                    res.PrimeKeyValue = SaveModel.PurchaseReceiptNoPrefixID;
                }
                catch (Exception ex)
                {
        ...
        public BeforeDeleteValidationResult ValidateBeforeDelete(long DeleteID)
        {
            ...
            using (dbMarkerEntities db = new dbMarkerEntities())
            {
                if (db.tblPurchaseBills.Any(r => r.CompanyID == Model.CommonProperties.LoginInfo.LoggedInCompany.CompanyID
                         && r.PurchaseReceiptNoPrefixID == DeleteID))
                {
                    Result.ValidationMessage = "Prefix exists in some Purchase Bills";
                }
            }
        ...
        public SavingResult DeleteRecord(long DeleteID)
        {
            ...
            using (dbMarkerEntities db = new dbMarkerEntities())
            {
                if (DeleteID != 0)
                {
                    tblPurchaseReceiptNoPrefix RecordToDelete = db.tblPurchaseReceiptNoPrefixes.FirstOrDefault(r => r.PurchaseReceiptNoPrefixID == DeleteID);
        ...
        public SavingResult DeleteRecord(tblPurchaseReceiptNoPrefix RecordToDelete, dbMarkerEntities db)
        {
            SavingResult res = new SavingResult();
            ...
            {
                db.tblPurchaseReceiptNoPrefixes.Remove(RecordToDelete);
            }
            return res;
        }
        ...
        public IEnumerable<IGridCRUDViewModel> GetViewModelList()
        {
            using (dbMarkerEntities db = new dbMarkerEntities())
            {
                return (from r in db.tblPurchaseReceiptNoPrefixes
                        ...
                        select new PurchaseReceiptNoPrefixViewModel()
                        {
        ...
        public PurchaseReceiptNoPrefixViewModel GetViewModelByPrimeKey(long ID)
        {
            using (dbMarkerEntities db = new dbMarkerEntities())
            {
                return (from r in db.tblPurchaseReceiptNoPrefixes
                        ...
                        where r.PurchaseReceiptNoPrefixID == ID
        ...
        public SavingResult UpdateRecordState(long ID, eRecordState newRecordState)
        {
            ...
            using (dbMarkerEntities db = new dbMarkerEntities())
            {
                var SaveModel = db.tblPurchaseReceiptNoPrefixes.Find(ID);
                if (SaveModel == null)
                {
                    res.ExecutionResult = eExecutionResult.ValidationError;
        ...
        public bool IsDuplicateRecord(string PrefixName, long ID, dbMarkerEntities db)
        {
            ...
            return db.tblPurchaseReceiptNoPrefixes.Any(r => r.CompanyID == Model.CommonProperties.LoginInfo.LoggedInCompany.CompanyID
                                && r.PrefixName.ToUpper() == PrefixName && r.PurchaseReceiptNoPrefixID != ID);
        }
        ...
        public List<PurchaseReceiptNoPrefixLookupListModel> GetLookupList()
        {
            using (dbMarkerEntities db = new dbMarkerEntities())
            {
                var res = (from r in db.tblPurchaseReceiptNoPrefixes
                           ...
                           select new PurchaseReceiptNoPrefixLookupListModel()
                           {
                               RecordState = (eRecordState)r.rstate,
                               PurchaseReceiptNoPrefixID = r.PurchaseReceiptNoPrefixID,
                               PrefixName = r.PrefixName,
