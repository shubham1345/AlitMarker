...
namespace Alit.Marker.DAL.Inventory.Transaction.StockIn
{
    public class StockInDAL : IDashboardDAL, ICRUDDAL, ILookupListDAL
    {
        ...
        {
            return SaveRecord((StockInViewModel)ViewModel);
        }

        public SavingResult SaveRecord(StockInViewModel ViewModel)
        {
        ...
        public SavingResult SaveRecord(StockInViewModel ViewModel, out tblStock SaveModel, dbMarkerEntities db, SavingResult res)
        {
            SaveModel = null;
            ...
            else if (IsDuplicateRecord(ViewModel.VoucherNo, ViewModel.StockInID, db))
            {
            ...
            res = StockVoucherDALObj.SaveNewRecord(new StockVoucherViewModel()
            {
                ...
                StockVoucherTypeID = eStockVoucherType.StockIn,
                ...
                {
                    StockVoucherID = ViewModel.StockInID,
        ...
        public IEnumerable<IDashboardViewModel> GetDashboardData(object[] FilterParas = null)
        {
            using (dbMarkerEntities db = new dbMarkerEntities())
            {
                ...
                int VTypeID = (int)eStockVoucherType.StockIn;
                ...
                return (from r in db.tblStocks
                        ...
                        select new StockInDashboardViewModel()
                        {
                            RecordState = (eRecordState)r.rstate,
                            StockInID = r.VoucherID,
                            VoucherDate = r.VDate,
                            VoucherNo = r.VNo,
                            ...
                            ProductDetail = (from rd in db.tblStockPDetails
                                             ...
                                             select new StockInDashboardProductDetailViewModel()
                                             {
                                                 StockInID = r.VoucherID,
                                                 StockInProductDetailID = rd.StockPDetailID,
        ...
        public StockInViewModel GetViewModelByPrimeKey(long ID)
        {
            using (dbMarkerEntities db = new dbMarkerEntities())
            {
                return (from r in db.tblStocks
                        ...
                        select new StockInViewModel()
                        {
                            ...
                            ProductDetail = (from pd in db.tblStockPDetails
                                             ...
                                             select new StockInProductDetailViewModel()
                                             {
        ...
        public IEnumerable<StockInLookUpListModel> GetLookupList()
        {
            return (List<StockInLookUpListModel>)GetLookupList(null);
        }
        ...
        public IEnumerable<ILookupListViewModel> GetLookupList(object[] FilterParas)
        {
            using (dbMarkerEntities db = new dbMarkerEntities())
            {
                ...
                var res = (from r in db.tblStocks
                           ...
                           select new StockInLookUpListModel()
                           {
                               RecordState = (eRecordState)r.rstate,
                               StockInID = r.VoucherID,
                               VoucherDate = r.VDate,
        ...
        {
            return StockVoucherDALObj.IsDuplicateStockVoucherNo(eStockVoucherType.StockIn, VoucherNo, ID);

        }

        public bool IsDuplicateRecord(long VoucherNo, long ID, dbMarkerEntities db)
        {
            return StockVoucherDALObj.IsDuplicateStockVoucherNo(eStockVoucherType.StockIn, VoucherNo, ID, db);
        }

        public long GenerateStockVNo()
        {
            return StockVoucherDALObj.GenerateStockVNo(eStockVoucherType.StockIn);
        }
    }
}
