...
{
    public partial class frmSaleRegister : Reports.Template.frmReportTemplate
    {
        ...
        public frmSaleRegister()
        {
            ...
            {
                lciCustomer.Visibility = DevExpress.XtraLayout.Utils.LayoutVisibility.Never;
            }
        }
        ...
        {
            DAL.Reports.Sales.SaleRegisterPrintDAL SInvDAL = new DAL.Reports.Sales.SaleRegisterPrintDAL();
            ...
            this.ReportTitle = "Sale Register " + this.ReportTitle;

            //XtraReport ReportSource = GetSelectedInvoiceFormat(SelectedInvoiceFormat);//new Reports.Sales.InvoiceFormats.rptInvoicePrintStandardA4();
            //List<SaleInvoicePrintModel> InvoiceListDS = SInvDAL.GenerateReportData((DateTime?)dteInvDateFrom.EditValue, (DateTime?)dtEditDateTo.EditValue, CustomerID);

            ReportSource = new rptSaleRegister();
            //XtraReport ReportSource = new Template.rptReportTemplateA4();
            //ReportSource.DataSource = new Model.Reports.CompanyDetailReportModel[] { Model.CommonProperties.LoginInfo.LoggedInCompanyReportModel }.ToList();
            ReportSource.DataSource = SInvDAL.GenerateReportData((DateTime?)dteInvDateFrom.EditValue, (DateTime?)dtEditDateTo.EditValue, CustomerID);
